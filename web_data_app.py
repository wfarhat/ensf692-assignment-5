...
def book_data():
    ...
    book_data["Sale price (25% off)"]= book_data["Prices"]*0.75
...
def learn():
    ...
    return "I learned many things in ENSF 692, but one of the things that I enjoyed the most was learning about Pandas, and how to use it to manipulate large amounts of data."
